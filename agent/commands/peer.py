...
from tools import read_secret_int, read_secret_json, require_secret, set_sentry, simple_run
...
async def get_info(request):
    asn = await read_secret_int(request)
...
async def setup_peer(request):
    peer_info = await read_secret_json(request)
